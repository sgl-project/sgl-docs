...
Before contributing, please ensure that your environment is set up correctly. Follow the steps in the [Installation Guide](https://github.com/sgl-project/sglang/blob/main/docs/hardware-platforms/ascend-npus/SGLang%20installation%20with%20NPUs%20support.md) to install the necessary dependencies. We recommend [using docker](https://github.com/sgl-project/sglang/blob/main/docs/hardware-platforms/ascend-npus/SGLang%20installation%20with%20NPUs%20support.md#docker) to build the environment.
