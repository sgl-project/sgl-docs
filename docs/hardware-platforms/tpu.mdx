...
<Tabs>
  ...
  <Tab title="Comprehensive Benchmark Script">
    ...
    See the [Benchmark and Profiling Guide](../developer-guide/benchmark-and-profiling) for advanced benchmarking techniques and profiling with JAX Profiler.
  </Tab>
</Tabs>
...
- Follow the [Benchmark and Profiling Guide](../developer-guide/benchmark-and-profiling) for performance validation
...
<CardGroup cols={2}>
  ...
  <Card title="Benchmark and Profiling Guide" icon="chart-bar" href="../developer-guide/benchmark-and-profiling">
