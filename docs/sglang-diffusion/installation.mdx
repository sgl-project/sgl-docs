...
<Tabs>
  <Tab title="ROCm (AMD GPUs)">
    **Platform:** AMD Instinct GPUs (ROCm)
    ...
    For detailed ROCm system configuration and installation from source, see [AMD GPUs](/docs/hardware-platforms/amd-gpus).
  </Tab>
  ...
  <Tab title="Ascend NPU">
    **Platform:** Ascend NPU
    ...
    For Ascend NPU, follow the [NPU installation guide](/docs/hardware-platforms/ascend-npus/SGLang%20installation%20with%20NPUs%20support).
